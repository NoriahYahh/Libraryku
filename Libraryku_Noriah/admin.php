  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search">
        ...
        <a class="btn btn-outline-danger ms-2" type="submit" href="logout.php">Lougout</a>
      </form>
    </div>
  </div>
</nav>
...
<a href="form-input.php" id="tambah" type="button" class="btn btn-src mb-2">Input Buku</a>
...
<table class="table table-bordered table-hover">
  ...
  <?php
    include'koneksi.php';
    $buku = mysqli_query($koneksi, "SELECT mdt_buku.*, admin.username from mdt_buku
    ...
    foreach ($buku as $row){
        ...
        <td>
        <a href='form-edit.php?id_buku=$row[id_buku]'>Edit</a>
        <a href='delete.php?id_buku=$row[id_buku]'>Delete</a>
    </td>
        </tr>"
        ;
        $no++;
...
<table class="table table-bordered table-hover">
  ...
  <?php
    ...
    foreach ($ta as $data){
        ...
        <td><a href='tolak.php?id_laporan=$data[id_laporan]'>Tolak</a>
        <a href='asset/buku/$row[file]#toolbar=0' target='_blank'>Baca</a></td>
        </tr>"
        ;
        $no++;
    }
